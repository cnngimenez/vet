...
module GUI
  ...
  module Exporters
    include Fox
    # CSV exporter window for Purchase instances.
    class CSVPurchasesExporter < CSVExporter
      def initialize(...)
        super(...)
      ...
      def warning_text
        ...
        str += '¡No se puede exportar más de 60 días!' if CSVExporters::PurchaseExporter.too_much_time?(from, to)
      ...
      def do_save
        ...
        exporter = CSVExporters::PurchaseExporter.new @ffrom_cal.selected, @fto_cal.selected
