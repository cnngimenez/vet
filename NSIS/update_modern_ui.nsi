...
OutFile "Update_Vet_MUI.exe"
ManifestSupportedOS all
RequestExecutionLevel admin
Unicode true
InstallDir "$LOCALAPPDATA\Vet"
InstallDirRegKey HKCU "Software\Vet" "Install_Dir"
...
LicenseText "Por favor, revise la licencia antes de actualizar Vet. Si acepta los términos, haga clic en el casillero de abajo. Luego, clic en Siguiente para continuar." "Siguiente"
DirText "Este programa actualizará Vet en la siguiente carpeta. Indique dónde instaló Vet: debe encontrarse los archivos $\"vet.rb$\", $\"Readme.org$\" y $\"db.rb$\" (ó $\"vet$\", $\"Readme$\" y $\"db$\") en ella. Si la carpeta que figura abajo no es la indicada, haga clic en Examinar y seleccione otro directorio. Clic en Instalar para comenzar la copia e instalación."
